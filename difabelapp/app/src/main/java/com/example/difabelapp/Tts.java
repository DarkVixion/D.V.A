package com.example.difabelapp;
...
public class Tts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance("https://difabel-app-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Images");
